...
var Ancestors=React.createClass({displayName: 'Ancestors',
  ...
  renderAncestor:function(n,idx) {
    ...
    return React.DOM.div({key: "a"+n, className: "node parent", 'data-n': n}, idx+1, ".", React.DOM.a({className: "text", href: "#", onClick: this.goback}, text), this.showHit(hit))
  },
  render:function() {
...
var Children=React.createClass({displayName: 'Children',
  ...
  renderChild:function(n) {
    ...
    var text=this.props.toc[n].text.trim();
    if (this.props.textConverter) text=this.props.textConverter(text);
    return React.DOM.div({key: "child"+n, 'data-n': n}, React.DOM.a({'data-n': n, className: classes +" tocitem text", onClick: this.nodeClicked}, text), this.showHit(hit))
  },
  showText:function(e) { 
    var target=e.target;
    var n=e.target.dataset.n;
  ...
  render: function() {
    ...
    return ( 
      React.DOM.div({className: "stacktoc"}, 
        ...
        React.DOM.div({className: "node current"}, React.DOM.a({href: "#", onClick: this.showText, 'data-n': this.state.cur}, React.DOM.span(null, depth, "."), React.DOM.span({className: "text"}, text)), this.showHit(current.hit)), 
...
require.register("ksanaforge-defaultmain/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var DefaultmainMixin = {
  ...
  renderinputs:function() {  // input interface for search
    if (this.state.db) {
      return (    
        React.DOM.div(null, 
        React.DOM.div({className: "centered inputs"}, React.DOM.input({size: "8", onKeyPress: this.keypress, ref: "tofind", defaultValue: this.defaultTofind||""}), 
  ...
  renderSlideButtons:function() {
    if (ksana.platform!="ios" && ksana.platform!="android") {
      return React.DOM.div(null, 
        React.DOM.button({onClick: this.slideToc}, "Toc"), 
        React.DOM.button({onClick: this.slideText}, "Text"), 
        React.DOM.button({onClick: this.slideSearch}, "Search")
      )
    }
  },
  ...
  renderMobile:function(text,pagename) {
     return (
      React.DOM.div({className: "main"}, 
        ...
        React.DOM.div({className: "swipediv"}, 
          this.renderStacktoc()
        ), 
        React.DOM.div({className: "swipediv"}, 
...
require.register("ksanaforge-defaultresultlist/index.js", function(exports, require, module){
/** @jsx React.DOM */
var Resultlist=React.createClass({displayName: 'Resultlist',  //should search result
  show:function() {  
    return this.props.res.excerpt.map(function(r,i){ // excerpt is an array 
      ...
      React.DOM.a({href: "#", onClick: this.gotopage, className: "sourcepage"}, r.pagename), ")", 
...
require.register("ksanaforge-defaultshowtext/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
var Controls = React.createClass({displayName: 'Controls',
  ...
  render: function() {   
   return React.DOM.div({className: "inputs"}, 
      React.DOM.button({onClick: this.props.prev}, "←"), 
       React.DOM.input({size: "8", type: "text", ref: "pagename", onKeyUp: this.updateValue}), 
  ...
  render: function() {
    ...
    return ( 
      React.DOM.div(null, 
        ...
        React.DOM.div({onTouchStart: this.touchstart, 
...
require.register("ksanaforge-dictionary/index.js", function(exports, require, module){
/** @jsx React.DOM */
var dictionary=require("./dictionary");
var Dictionary=React.createClass({displayName: 'Dictionary',
	...
	render:function() { 
		return React.DOM.div({className: "modalDialog ", ref: "dictdialog"}, 
			React.DOM.div(null, 
			React.DOM.a({href: "#", onClick: this.closeDialog, 
...
require.register("ksanaforge-dictionary/dictionary.js", function(exports, require, module){
var kde=Require("ksana-document").kde;
...
require.register("_2048-main/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("_2048-comp1/index.js", function(exports, require, module){
/** @jsx React.DOM */
...
require.register("_2048/index.js", function(exports, require, module){
...
require.alias("ksanaforge-boot/index.js", "_2048/deps/boot/index.js");
require.alias("ksanaforge-boot/ksanagap.js", "_2048/deps/boot/ksanagap.js");
require.alias("ksanaforge-boot/downloader.js", "_2048/deps/boot/downloader.js");
require.alias("ksanaforge-boot/kfs.js", "_2048/deps/boot/kfs.js");
require.alias("ksanaforge-boot/kfs_html5.js", "_2048/deps/boot/kfs_html5.js");
require.alias("ksanaforge-boot/mkdirp.js", "_2048/deps/boot/mkdirp.js");
require.alias("ksanaforge-boot/index.js", "_2048/deps/boot/index.js");
require.alias("ksanaforge-boot/index.js", "boot/index.js");
require.alias("ksanaforge-boot/index.js", "ksanaforge-boot/index.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "_2048/deps/bootstrap/dist/js/bootstrap.js");
require.alias("brighthas-bootstrap/dist/js/bootstrap.js", "_2048/deps/bootstrap/index.js");
...
require.alias("ksana-document/index.js", "_2048/deps/ksana-document/index.js");
require.alias("ksana-document/document.js", "_2048/deps/ksana-document/document.js");
require.alias("ksana-document/api.js", "_2048/deps/ksana-document/api.js");
require.alias("ksana-document/xml.js", "_2048/deps/ksana-document/xml.js");
require.alias("ksana-document/template_accelon.js", "_2048/deps/ksana-document/template_accelon.js");
require.alias("ksana-document/persistent.js", "_2048/deps/ksana-document/persistent.js");
require.alias("ksana-document/tokenizers.js", "_2048/deps/ksana-document/tokenizers.js");
require.alias("ksana-document/markup.js", "_2048/deps/ksana-document/markup.js");
require.alias("ksana-document/typeset.js", "_2048/deps/ksana-document/typeset.js");
require.alias("ksana-document/sha1.js", "_2048/deps/ksana-document/sha1.js");
require.alias("ksana-document/users.js", "_2048/deps/ksana-document/users.js");
require.alias("ksana-document/customfunc.js", "_2048/deps/ksana-document/customfunc.js");
require.alias("ksana-document/configs.js", "_2048/deps/ksana-document/configs.js");
require.alias("ksana-document/projects.js", "_2048/deps/ksana-document/projects.js");
require.alias("ksana-document/indexer.js", "_2048/deps/ksana-document/indexer.js");
require.alias("ksana-document/indexer_kd.js", "_2048/deps/ksana-document/indexer_kd.js");
require.alias("ksana-document/kdb.js", "_2048/deps/ksana-document/kdb.js");
require.alias("ksana-document/kdbfs.js", "_2048/deps/ksana-document/kdbfs.js");
require.alias("ksana-document/kdbw.js", "_2048/deps/ksana-document/kdbw.js");
require.alias("ksana-document/kdb_sync.js", "_2048/deps/ksana-document/kdb_sync.js");
require.alias("ksana-document/kdbfs_sync.js", "_2048/deps/ksana-document/kdbfs_sync.js");
require.alias("ksana-document/html5fs.js", "_2048/deps/ksana-document/html5fs.js");
require.alias("ksana-document/kdbfs_android.js", "_2048/deps/ksana-document/kdbfs_android.js");
require.alias("ksana-document/kdbfs_ios.js", "_2048/deps/ksana-document/kdbfs_ios.js");
require.alias("ksana-document/kse.js", "_2048/deps/ksana-document/kse.js");
require.alias("ksana-document/kde.js", "_2048/deps/ksana-document/kde.js");
require.alias("ksana-document/boolsearch.js", "_2048/deps/ksana-document/boolsearch.js");
require.alias("ksana-document/search.js", "_2048/deps/ksana-document/search.js");
require.alias("ksana-document/plist.js", "_2048/deps/ksana-document/plist.js");
require.alias("ksana-document/excerpt.js", "_2048/deps/ksana-document/excerpt.js");
require.alias("ksana-document/link.js", "_2048/deps/ksana-document/link.js");
require.alias("ksana-document/tibetan/wylie.js", "_2048/deps/ksana-document/tibetan/wylie.js");
require.alias("ksana-document/languages.js", "_2048/deps/ksana-document/languages.js");
require.alias("ksana-document/diff.js", "_2048/deps/ksana-document/diff.js");
require.alias("ksana-document/xml4kdb.js", "_2048/deps/ksana-document/xml4kdb.js");
require.alias("ksana-document/buildfromxml.js", "_2048/deps/ksana-document/buildfromxml.js");
require.alias("ksana-document/tei.js", "_2048/deps/ksana-document/tei.js");
require.alias("ksana-document/concordance.js", "_2048/deps/ksana-document/concordance.js");
require.alias("ksana-document/regex.js", "_2048/deps/ksana-document/regex.js");
require.alias("ksana-document/bsearch.js", "_2048/deps/ksana-document/bsearch.js");
require.alias("ksana-document/persistentmarkup_pouchdb.js", "_2048/deps/ksana-document/persistentmarkup_pouchdb.js");
require.alias("ksana-document/underlines.js", "_2048/deps/ksana-document/underlines.js");
require.alias("ksana-document/index.js", "_2048/deps/ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksana-document/index.js", "ksana-document/index.js");
require.alias("ksanaforge-stacktoc/index.js", "_2048/deps/stacktoc/index.js");
require.alias("ksanaforge-stacktoc/index.js", "_2048/deps/stacktoc/index.js");
...
require.alias("ksanaforge-fileinstaller/index.js", "_2048/deps/fileinstaller/index.js");
require.alias("ksanaforge-fileinstaller/index.js", "_2048/deps/fileinstaller/index.js");
...
require.alias("ksanaforge-checkbrowser/index.js", "_2048/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "_2048/deps/checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "checkbrowser/index.js");
require.alias("ksanaforge-checkbrowser/index.js", "ksanaforge-checkbrowser/index.js");
require.alias("ksanaforge-swipe/index.js", "_2048/deps/swipe/index.js");
require.alias("ksanaforge-swipe/swipe.js", "_2048/deps/swipe/swipe.js");
require.alias("ksanaforge-swipe/index.js", "_2048/deps/swipe/index.js");
require.alias("ksanaforge-swipe/index.js", "swipe/index.js");
require.alias("ksanaforge-swipe/index.js", "ksanaforge-swipe/index.js");
require.alias("ksanaforge-defaultmain/index.js", "_2048/deps/defaultmain/index.js");
require.alias("ksanaforge-defaultmain/index.js", "_2048/deps/defaultmain/index.js");
require.alias("ksanaforge-defaultmain/index.js", "defaultmain/index.js");
require.alias("ksanaforge-defaultmain/index.js", "ksanaforge-defaultmain/index.js");
require.alias("ksanaforge-defaultresultlist/index.js", "_2048/deps/defaultresultlist/index.js");
require.alias("ksanaforge-defaultresultlist/index.js", "_2048/deps/defaultresultlist/index.js");
require.alias("ksanaforge-defaultresultlist/index.js", "defaultresultlist/index.js");
require.alias("ksanaforge-defaultresultlist/index.js", "ksanaforge-defaultresultlist/index.js");
require.alias("ksanaforge-defaultshowtext/index.js", "_2048/deps/defaultshowtext/index.js");
require.alias("ksanaforge-defaultshowtext/index.js", "_2048/deps/defaultshowtext/index.js");
require.alias("ksanaforge-defaultshowtext/index.js", "defaultshowtext/index.js");
require.alias("ksanaforge-defaultshowtext/index.js", "ksanaforge-defaultshowtext/index.js");
require.alias("ksanaforge-dictionary/index.js", "_2048/deps/dictionary/index.js");
require.alias("ksanaforge-dictionary/dictionary.js", "_2048/deps/dictionary/dictionary.js");
require.alias("ksanaforge-dictionary/index.js", "_2048/deps/dictionary/index.js");
require.alias("ksanaforge-dictionary/index.js", "dictionary/index.js");
require.alias("ksanaforge-dictionary/index.js", "ksanaforge-dictionary/index.js");
require.alias("ksanaforge-htmlfs/index.js", "_2048/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "_2048/deps/htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "htmlfs/index.js");
require.alias("ksanaforge-htmlfs/index.js", "ksanaforge-htmlfs/index.js");
require.alias("_2048-main/index.js", "_2048/deps/main/index.js");
require.alias("_2048-main/index.js", "_2048/deps/main/index.js");
require.alias("_2048-main/index.js", "main/index.js");
require.alias("_2048-main/index.js", "_2048-main/index.js");
require.alias("_2048-comp1/index.js", "_2048/deps/comp1/index.js");
require.alias("_2048-comp1/index.js", "_2048/deps/comp1/index.js");
require.alias("_2048-comp1/index.js", "comp1/index.js");
require.alias("_2048-comp1/index.js", "_2048-comp1/index.js");
require.alias("_2048/index.js", "_2048/index.js");
